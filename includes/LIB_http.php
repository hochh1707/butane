...
define("WEBBOT_NAME", "Mozilla/5.0 (Windows NT 5.1; rv:9.0.1) Gecko/20100101 Firefox/9.0.1");

define('TEST_SUBMIT','http://www.schrenk.com/nostarch/webbots/form_analyzer.php');
...
function http($target, $ref, $method, $data_array, $incl_head)
    ...
    if($method == HEAD)
		...
		//  This option does not work on ablestake.com server
